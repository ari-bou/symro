"""
Adapted from the ordered-set library.
Speer, R., Crall, J., Inflianskas, ordered-set 4.0.2, https://pypi.org/project/ordered-set/.
...
class OrderedSet(MutableSet[T], Sequence[T]):
    ...
    def __getitem__(self, index: Union[int, Sequence[int], slice]) -> Union[T, List[T], "OrderedSet[T]"]:
        """
    ...
    def __setitem__(self, index: Union[int, Sequence[int], slice], item: Union[T, Sequence[T]]):

        # index
        if hasattr(index, "__index__"):
            old_item = self.items[index]
            del self.map[old_item]
    ...
    def index(self, key: Union[T, Sequence[T]]) -> Union[T, List[int]]:
        """
