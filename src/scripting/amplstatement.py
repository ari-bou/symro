...
from symro.src.scripting.script import BaseStatement, Script, CompoundScript
...
class TableDeclaration(BaseStatement):
    ...
    @staticmethod
    def build_table_key_spec(set_expr_node: mat.SetExpressionNode,
                             arrow_token: str,
                             key_col_specs: List[Tuple[mat.ExpressionNode, mat.ExpressionNode]]):
...
class DisplayStatement(BaseStatement):
    ...
    def __init__(self,
        ...
        self.command: str = command
        self.idx_set_node: mat.SetExpressionNode = idx_set_node
        self.arg_list: List[Union[mat.ExpressionNode, DisplayStatement.IndexedArgList]] = arg_list
        self.redirection: Redirection = redirection

    @staticmethod
    def build_indexed_arg_list(idx_set_node: mat.SetExpressionNode,
                               arg_nodes: List[mat.ExpressionNode]):
...
def add_included_script_to_compound_script(compound_script: CompoundScript,
